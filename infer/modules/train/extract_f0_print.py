...
if __name__ == "__main__":
    ...
    # macOS MPS + RMVPE is more stable in single-process mode.
    if "mps" in str(device) and f0method == "rmvpe":
        printt("macOS MPS detected for RMVPE, forcing single-process extraction")
        n_p = 1
